...
def make_model(args, parent=False):
    if args.dilation:
        ...
        return MultiEDSR_MetaShuffle_n(args, dilated.dilated_conv)
    else:
        return MultiEDSR_MetaShuffle_n(args)
...
class MultiEDSR_MetaShuffle_n(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(MultiEDSR_MetaShuffle_n, self).__init__()
